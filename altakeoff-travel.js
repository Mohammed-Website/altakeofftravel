        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/altakeofftravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض اوروبا',
        image_1: ['عروض-شركة-الانطلاق/عروض-اوروبا/عرض-اوروبا-1.jpg', 'النمسا & التشيك & المانيا & فيينا & براغ & ميونخ'],
        image_2: ['عروض-شركة-الانطلاق/عروض-اوروبا/عرض-اوروبا-2.jpg', 'ايطاليا & سويسرا & فرنسا & المانيا'],
        image_3: ['عروض-شركة-الانطلاق/عروض-اوروبا/عرض-اوروبا-3.jpg', 'ايطاليا & النمسا & سويسرا & فرنسا & المانيا'],
        image_4: ['عروض-شركة-الانطلاق/عروض-اوروبا/عرض-اوروبا-4.jpg', 'ايطاليا & النمسا & سويسرا & فرنسا & المانيا'],
    },

    {
        title: 'عروض مشهد',
        image_1: ['عروض-شركة-الانطلاق/عروض-مشهد/عرض-مشهد-1.jpg', 'عرض مشهد - رحلات إجازة الربيع'],
    },
    
    {
        title: 'عروض النرويج',
        image_1: ['عروض-شركة-الانطلاق/عروض-النرويج/عرض-النرويج-1.jpg', 'ترومسو & اوسلو & تريسل'],
    },


    {
        title: 'عروض ايطاليا',
        image_1: ['عروض-شركة-الانطلاق/عروض-ايطاليا/عرض-ايطاليا-1.jpg', 'روما & فلورنسا & البندقية & ميلان & كومو'],
        image_2: ['عروض-شركة-الانطلاق/عروض-ايطاليا/عرض-ايطاليا-2.jpg', 'ميلان - الشمال الإيطالي '],
    },

    {
        title: 'عروض بريطانيا',
        image_1: ['عروض-شركة-الانطلاق/عروض-بريطانيا/عرض-بريطانيا-1.jpg', 'أدنبره & إنفرنيس & غلاسكو & لندن'],
    },

    {
        title: 'عروض النمسا',
        image_1: ['عروض-شركة-الانطلاق/عروض-النمسا/عرض-النمسا-1.jpg', 'عرض النمسا VIP - فيينا'],
        image_2: ['عروض-شركة-الانطلاق/عروض-النمسا/عرض-النمسا-2.jpg', 'عرض النمسا - فيينا 6 أيام'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-الانطلاق/عروض-لندن/عرض-لندن-1.jpg', 'عرض لندن - 6 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97332201197?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/altakeofftravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة الانطلاق على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة الانطلاق على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة الانطلاق على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة الانطلاق للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة الانطلاق للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة الانطلاق`;
            img.title = `مكتب سياحي - شركة الانطلاق`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97332201197";
